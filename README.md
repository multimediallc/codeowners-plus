...
# diff it would be judged on cannot be computed. Off by default because it reaches
# the network: one fetch per unresolvable commit, bounded at 60s plus a short grace
# for the transport helper to exit.
